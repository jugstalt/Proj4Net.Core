...
public class CoordinateTransformTest : BaseCoordinateTransformTest
{
    ...
    public void TestNadGrids_atNULL()  // +nadgrids=@null
    {
        ...
        CheckTransform("EPSG:31255", 196022.96, 199943.9, "EPSG:3857", 1770614.1566190317, 5927358.7994835, 0.01);
        CheckTransform(
            "+proj=tmerc +lat_0=0 +lon_0=16.333333333333 +k=1.000000 +x_0=0 +y_0=-5000000 +ellps=bessel +units=m +towgs84=577.326,90.129,463.919,5.137,1.474,5.297,2.4232",
            -32495.25, 196816.39,
            "EPSG:3857",
            1770614.150, 5927358.799, 0.01);
        CheckTransform("EPSG:4326", 16D, 47D, "EPSG:31256", -25267.879, 206812.089, 0.01);
